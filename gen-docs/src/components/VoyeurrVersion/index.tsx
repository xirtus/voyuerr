    ...
    async function fetchVersion() {
      try {
        const response = await fetch(
          'https://raw.githubusercontent.com/xirtus/voyuerr/main/package.json'
        );
...
export const NixpkgVersion = () => {
  ...
  useEffect(() => {
    const fetchVersion = async () => {
      try {
        const unstableUrl =
          'https://raw.githubusercontent.com/NixOS/nixpkgs/refs/heads/nixos-unstable/pkgs/by-name/se/voyeurr/package.nix';
        const stableUrl =
          'https://raw.githubusercontent.com/NixOS/nixpkgs/refs/heads/nixos-26.05/pkgs/by-name/se/voyeurr/package.nix';
