...
class CacheManager {
  private availableCaches: Record<AvailableCacheIds, Cache> = {
    ...
    whisparr: new Cache('whisparr', 'Whisparr API'),
    ...
    tpdb: new Cache('tpdb', 'ThePornDB API', {
      stdTtl: 21600,
      checkPeriod: 60 * 30,
    }),
    r18: new Cache('r18', 'R18.dev / JavDB API', {
      stdTtl: 21600,
      checkPeriod: 60 * 30,
    }),
    adultdvdempire: new Cache('adultdvdempire', 'AdultDVDEmpire API', {
      stdTtl: 43200,
      checkPeriod: 60 * 30,
    }),
    nhentai: new Cache('nhentai', 'nHentai API', {
      stdTtl: 21600,
      checkPeriod: 60 * 30,
    }),
    hanime: new Cache('hanime', 'Hanime API', {
      stdTtl: 21600,
      checkPeriod: 60 * 30,
    }),
    fakku: new Cache('fakku', 'Fakku API', {
      stdTtl: 21600,
      checkPeriod: 60 * 30,
    }),
  };
