...
type ExternalLinkType = 'movie' | 'tv' | 'person' | 'scene';
...
// Stash link rendering will be added at render time
// mediaType 'scene' with stashUrl will show a link
