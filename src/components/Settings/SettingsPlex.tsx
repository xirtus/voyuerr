...
const messages = defineMessages('components.Settings', {
  ...
  plexsettingsDescription:
    'Configure the settings for your Plex server. Voyeurr scans your Plex libraries to determine content availability.',
  serverpreset: 'Server',
  serverLocal: 'local',
  serverRemote: 'remote',
  serverSecure: 'secure',
  ...
  plexlibrariesDescription:
    'The libraries Voyeurr scans for titles. Set up and save your Plex connection settings, then click the button below if no libraries are listed.',
  scanning: 'Syncing…',
  scan: 'Sync Libraries',
  manualscan: 'Manual Library Scan',
  manualscanDescription:
    "Normally, this will only be run once every 24 hours. Voyeurr will check your Plex server's recently added more aggressively. If this is your first time configuring Plex, a one-time full manual library scan is recommended!",
  ...
  tautulliSettingsDescription:
    'Optionally configure the settings for your Tautulli server. Voyeurr fetches watch history data for your Plex media from Tautulli.',
  urlBase: 'URL Base',
      ...
      <div className="section">
        <div className="rounded-md bg-gray-800 p-4">
          <div className="relative mb-6 h-8 w-full overflow-hidden rounded-full bg-gray-600">
            {dataSync?.running && (
              <div
                className="h-8 bg-[#ff3366] transition-all duration-200 ease-in-out"
                style={{
                  width: `${Math.round(
