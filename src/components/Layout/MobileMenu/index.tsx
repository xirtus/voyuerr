              ...
              {link.href === '/requests' &&
                ...
                hasPermission(Permission.MANAGE_REQUESTS) && (
                  <div className="ml-auto flex">
                    <Badge className="rounded-md border-[#ff3366] bg-gradient-to-br from-[#ff3366] to-purple-600">
                      {pendingRequestsCount}
                    </Badge>
                  </div>
                )}
                        ...
                        <Badge
                          className={`bg-gradient-to-br ${
                            router.pathname.match(link.activeRegExp)
                              ? 'border-[#ff3366] from-[#ff1a53] to-purple-700'
                              : 'border-[#ff3366] from-[#ff3366] to-purple-600'
                          } flex ${
